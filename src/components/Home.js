...
class Home extends Component {  
  handleSubmit = (e) =>{
    ...
    let path =  `teachers/${teacherTopic}/${teacherName}`; //* Sets the path from App.js*
    this.props.history.push(path); //* push the values into history*
  };  
    ...
    return (
      <div className="main-content home">
        ...
        <form onSubmit={this.handleSubmit}>
          <input type="text" placeholder="Name" ref={(input) => this.name = input}/> {/* takes a callback function refs App.js this.name */}
